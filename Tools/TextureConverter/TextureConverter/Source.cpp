...
{
	std::cout << std::endl << "--------------Texture Converter Running--------------" << std::endl;
	...
	std::string cmd = R"(..\..\Tools\TextureConverter\texconv.exe -f BC7_UNORM -pow2 -bcmax -fl 11.1 ")";
