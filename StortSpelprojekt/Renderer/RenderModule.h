...
namespace Renderer
{
	...
	private:
		...
		void SetDataPerSkinnedObject(DirectX::XMMATRIX* world, DirectX::XMMATRIX* extra, int boneCount, DirectX::XMFLOAT3 colorOffset = DirectX::XMFLOAT3(0, 0, 0));
	...
	public:
		...
		const DirectX::XMFLOAT3 AMBIENT_LIGHT = DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f);
		...
		void RenderAnimation(DirectX::XMMATRIX* world, int vertexBufferSize, DirectX::XMMATRIX* extra, int boneCount, DirectX::XMFLOAT3 colorOffset = DirectX::XMFLOAT3(0, 0, 0));
